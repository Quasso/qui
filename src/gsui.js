...
var gsui = function(method, element, options, callback) {
    ...
    if (typeof document.querySelector('.gsui-active') === null) {
		...
		**************************/
            case 'arrow':
                console.log('Slide down fade out..');
                animate.fromTo(
                    element, duration, {
                        delay: delay,
                        opacity: 1,
                        ...
                        scale: 0.8,
                        onComplete: function() {
                            animationComplete(element, method)
                        }
                    }
                );
                break;
            ...
            case 'zoomOut':
                ...
                break;
            case 'tada':
                animate.from(element, duration / 6, {
                    scale: 0.6
                }).to(
                    element, duration / 6, {
                        rotation: "10%",
                ...
                break;
            case 'shake':
                animate.to(element, duration / 6, {
                        left: "+=" + (nudge / 2),
                        ease: easing
                    })
                    .to(element, duration / 6, {
                        left: "-=" + nudge,
                        ease: easing
                    })
                    .to(element, duration / 6, {
